...
include_once TMM_EXT_PATH . '/mobileDetect/Mobile_Detect.php';
...
if ( !function_exists('tmm_admin_enqueue_scripts') ) {
	function tmm_admin_enqueue_scripts() {
		...
		$translation_array = array(
			...
			'theme_url' => esc_js(TMM_THEME_URI),
	...
	function tmm_get_plugins() {
		...
		return array(
			...
			*/
			...
			array(
				'name'               => esc_html__( 'ThemeMakers Diplomat Features', 'diplomat' ),
			...
			array(
				'name'               => esc_html__( 'ThemeMakers DB Migrate', 'diplomat' ),
				'slug'               => 'tmm_db_migrate',
			...
			array(
				'name'               => esc_html__( 'ThemeMakers Visual Content Composer', 'diplomat' ),
				'slug'               => 'tmm_content_composer',
				'source'             => 'https://github.com/ThemeMakers/tmm_content_composer/archive/diplomat_v1.1.1.zip',
				'required'           => true,
				'version'           => '1.1.1',
			),
			array(
				'name'               => esc_html__( 'ThemeMakers Events', 'diplomat' ),
				'slug'               => 'tmm_events_calendar',
				'source'             => 'https://github.com/ThemeMakers/tmm_events_calendar/archive/diplomat_v1.1.0.zip',
				'required'           => false,
				'version'           => '1.1.0',
			),
			array(
				'name'               => esc_html__( 'Seamless Donations', 'diplomat' ),
				'slug'               => 'seamless-donations',
				'source'             => 'https://downloads.wordpress.org/plugin/seamless-donations.4.0.20.zip',
				'required'           => false,
				'version'           => '4.0.20',
			),
			array(
				'name'               => esc_html__( 'Envato WordPress Toolkit', 'diplomat' ),
			...
			array(
				'name'               => esc_html__( 'Arqam', 'diplomat' ),
				'slug'               => 'arqam',
				'source'             => TMM_THEME_URI . '/install/arqam.zip',
				'required'           => false,
				'version'           => '2.4.0',
			),
			array(
				'name'               => esc_html__( 'bbPress', 'diplomat' ),
				'slug'               => 'bbpress',
				'source'             => 'https://downloads.wordpress.org/plugin/bbpress.2.5.14.zip',
				'required'           => false,
				'version'           => '2.5.14',
			),
			array(
				'name'               => esc_html__( 'LayerSlider', 'diplomat' ),
				'slug'               => 'LayerSlider',
				'source'             => TMM_THEME_URI . '/install/layersliderwp-6.7.0.zip',
				'required'           => false,
				'version'           => '6.7.0',
			),
...
//Addtitional for WPML only flags

//For two language flags
/** 
 * function wpml_nav_menu_items($items) {
 *     if (function_exists('icl_get_languages')) {
 *     $languages = icl_get_languages('skip_missing=0');
 *     if (1 < count($languages)) {
 *         foreach ($languages as $l) {        
 *             $items = $items . '<li class="menu-item custom-switcher"><a href="' . $l['url'] . '"><img src="' . $l['country_flag_url'] . '" height="12" alt="' . $l['language_code'] . '" width="18" /></a></li>';     
 *         }
 *     }
 *     }
 *  
 ...
 * }
 *  
 * add_filter('wp_nav_menu_items', 'wpml_nav_menu_items');
 */
 
 // For One language flag
/**
